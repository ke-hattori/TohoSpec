========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : Glassine
========================================================================


AppWizard が生成した Glassine には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには Glassine を構成している各ファイルの概要説明が含まれています。
...
Glassine.h
    ...
    みます） をインクルードし、また CGlassineApp アプリケーションクラスを宣
    言します。

Glassine.cpp
    このファイルは CGlassineApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\Glassine.ico
    ...
    ルです。このアイコンはリソース ファイル Glassine.rc によってインクルード
    されます。
...
GlassineDlg.h, GlassineDlg.cpp - ダイアログ
    これらのファイルは CGlassineDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な Glassine.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) Glassine.pch 
