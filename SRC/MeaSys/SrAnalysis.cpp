...
/* added 2009.07.07 hmenjo dll ���΃p�X�Ή� MeaSys.dll ---------- { ---------- */
...
// 2009.05.18 K.Matsuo �o�O�Ή� ��Δ��˗���100%�����Ă�����A100%�ɂ��Ă����Ή� -->
			// ���̎��_�́A�܂����Δ��˗��ł����̂ŁA���̂��ߍ폜���܂����B�B�B
//			if ( ResultData[i] > 1.0 )
//				ResultData[i] = 1.0;
// 2009.05.18 K.Matsuo �o�O�Ή� ��Δ��˗���100%�����Ă�����A100%�ɂ��Ă����Ή� <--
		}
...
//'====================================================
//'
//'   �F�x���荀�ڊe��v�ZPart1�iXYZ,XnYnZn�j
//'   COD_SdataModi�f�[�^����F�x���v�Z
//'   ���L�����u���[�V�����@�\�̂��߂ɂQ�ɕ���
//'   Part1�ł́uXYZ�v���߁A���L�����u��APart2�ɂĕ␳���XYZ�ɂČv�Z
//'
//'====================================================
//*/
//
...
//		::MessageBox(NULL, _T("CIE �C���~�i���g�v�Z���s ReadIllumiFile"), _T("NanoSpec"), MB_OK | MB_ICONERROR);
//		return;
//	}
//	if ( !ReadCIECMFFile() ) {
//		::MessageBox(NULL, _T("CIE �C���~�i���g�v�Z���s ReadCIECMFFile"), _T("NanoSpec"), MB_OK | MB_ICONERROR);
//		return;
//	}
//
...
//	  cieStarV As Double
//
//	  cieTempXn As Double	 '�v�Ztemp�i���L�����u���[�V�����̂���temp���O���[�o�������K�v�j
//	  cieTempYn As Double	 '�v�Ztemp�i���L�����u���[�V�����̂���temp���O���[�o�������K�v�j
//	  cieTempZn As Double	 '�v�Ztemp�i���L�����u���[�V�����̂���temp���O���[�o�������K�v�j
//End Type
...
//'====================================================
//'
//'   �F�x���荀�ڊe��v�ZPart2�ixyz,Lab,a*b*,u'v',u*v*�j
//'   COD_SdataModi�f�[�^����F�x���v�Z
//'   ���L�����u���[�V�����@�\�̂��߂ɂQ�ɕ���
//'  Part1�ł́uXYZ�v���߁A���L�����u��APart2�ɂĕ␳���XYZ�ɂČv�Z
//'
...
//		  CIE_Result.cieSmallz = CIE_Result.cieLargeZ / (CIE_Result.cieLargeX + CIE_Result.cieLargeY + CIE_Result.cieLargeZ); // Smallz = 1 - Smallx - Smally �Ɠ���
//	  }
//
//	  //'[L,a,b]
...
//	  }
//
//	  //'[u'n,v'n (Complete refrection)]�\���Ȃ�    // ���S�g�U�ʂŌv�Z����u',v'�l
...
/* added 2009.07.07 hmenjo dll ���΃p�X�Ή� MeaSys.dll ---------- } ---------- */
	...
	if ( (fp = fopen(szFilename, _T("r"))) == NULL ) {
		TCHAR szBuff[256];
		_stprintf(szBuff, _T("%s%s"), szFilename, _T("������܂���"));
...
BOOL CSrAnalysis::DoXmp(LPTSTR pszXmpDdeText, ANALYSISDATA* pAnalysisData, const MAIN_RCP_INFO* pMainRcpInfo, const MEAS_PROG_INFO* pMeasProgInfo, CDdeClient* pXmpDde)
{
	...
	// FITDATA�R�}���h���M
// 2009.09.14 K.Matsuo NanoSpec6500,9300�R�}���h �݊��Ή� -->
//		6500 : strategy
//		9300 : StratNum
...
/* added 2016.02.24 hmenjo �o�b�`���� ---------- } ---------- */
	...
	if ( (fp = fopen(pszFullPath, _T("w"))) == NULL )  {
		_stprintf(szBuff, _T("%s%s"), pszFullPath, _T("�̍쐬�Ɏ��s���܂���"));
...
// 2014.04.03 bagus wavelength step modified <--
	...
	if ( !file.Open(pszFullPath, CFile::modeRead | CFile::typeText | CFile::shareDenyNone) )  {
		_stprintf(szBuff, _T("%s%s"), pszFullPath, _T("�̓Ǎ��݂Ɏ��s���܂���"));
//		::MessageBox(NULL, szBuff, _T("NanoSpec"), MB_OK | MB_ICONERROR);
		return FALSE;
	}
...
//
//'CIE 1931 2-deg XYZ Color Matching Functions��`�l�z��
...
/* MFC �Ɠ����^�C�v�̃t�@�C���I���_�C�A���O�\���p	*/
UINT CALLBACK OFNHookProcOldStyle(
	HWND hdlg,		/* �_�C�A���O�{�b�N�X�E�B���h�E�̃n���h��	*/
	UINT uiMsg,		/* ���b�Z�[�W���ʎq	*/
	WPARAM wParam,	/* ���b�Z�[�W�p�����[�^	*/
...
)
{
	...
	case WM_INITDIALOG:
		{
			/* �t�@�C���I���_�C�A���O���f�X�N�g�b�v�̒����ɕ\�����܂��D	*/
...
{
	BOOL l_bRc = FALSE;
	static TCHAR ls_tszAft2AdapPathSrc[MAX_PATH] = _T("");	/* �O��I�������t�@�C���̃t���p�X	*/
	...
	if (-1 != ::GetFileAttributes(ls_tszAft2AdapPathSrc)) {
		...
		if (FALSE != l_bDef) {
			l_bDef = FALSE;
			/* ptszFullPath �̃f�B���N�g�����g���܂��D	*/
			_tcscpy(l_tszAft2AdapDir, ptszFullPath);
			l_ptszNull = _tcsrchr(l_tszAft2AdapDir, _T('\\'));
			/* ptszFullPath �̃f�B���N�g���͑��݂��邩�H�H	*/
			if (0 == l_ptszNull) {
				/* �p�X��'\'������	*/
				l_bDef = TRUE;
			} else {
	...
	l_OpenFileName.lpfnHook = OFNHookProcOldStyle;	/* �t�b�N�v���V�[�W��	*/
	l_OpenFileName.Flags =
						OFN_FILEMUSTEXIST |		/* ���݂���p�X�̂ݗL��	*/
						OFN_PATHMUSTEXIST |		/* ���݂���t�@�C���̂ݗL��	*/
						OFN_NONETWORKBUTTON |	/* �l�b�g���[�N�{�^����\��	*/
						OFN_ENABLEHOOK |		/* �t�b�N�v���V�[�W����L��	*/
						OFN_EXPLORER |			/* �V�����G�N�X�v���[���X�^�C��	*/
						0;
	/* �J�����g�f�B���N�g����ۑ�	*/
