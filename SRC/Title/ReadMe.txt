========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : NanoSpecTitle
========================================================================


AppWizard が生成した NanoSpecTitle には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには NanoSpecTitle を構成している各ファイルの概要説明が含まれています。
...
NanoSpecTitle.h
    ...
    みます） をインクルードし、また CNanoSpecTitleApp アプリケーションクラスを宣
    言します。

NanoSpecTitle.cpp
    このファイルは CNanoSpecTitleApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\NanoSpecTitle.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル NanoSpecTitle.rc によってインクルード
    されます。

res\NanoSpecTitle.rc2
...
NanoSpecTitleDlg.h, NanoSpecTitleDlg.cpp - ダイアログ
    これらのファイルは CNanoSpecTitleDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な NanoSpecTitle.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) NanoSpecTitle.pch 
