// SitePatternEditDlg.cpp : インプリメンテーション ファイル
//
...
/////////////////////////////////////////////////////////////////////////////
// CSitePatternEditDlg メッセージ ハンドラ
...
{
//	MessageBox(	"パターンファイルが多いと時間がかかることがあります\nしばらくお待ち下さい...",
//				"パターン読み込み処理",
//				MB_OK);
	CExecutionDlg dlg;
//	dlg.SetCaption(IDS_EXECUTION_CAPTION);
	...
	//Saiki 20090601 Change ----->
	//dlg.SetMessage("パターンファイルが多いと時間がかかることがあります\nしばらくお待ち下さい...");
