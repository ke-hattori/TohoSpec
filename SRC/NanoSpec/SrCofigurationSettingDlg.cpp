// SrCofigurationSettingDlg.cpp : インプリメンテーション ファイル
//
...
// =========================================================================
// CSrCofigurationSettingDlg メッセージ ハンドラ
...
void CSrCofigurationSettingDlg::OnReferenceDataFolderPathButton()
{
	...
	// メッセージボックスのオーナーにしたいィンドウハンドルを指定する
	HWND hWnd = this->GetSafeHwnd();
...
{
	// Choose AF Function in Referenceのチェックボックスの有効無効の切り替え
...
{
	/* Use Optical Filter of Meas.-PGM at AF のチェックボックスの有効無効の切り替え	*/
