// UserAccountListDlg.cpp : インプリメンテーション ファイル
//
...
// =========================================================================
// CUserAccountListDlg メッセージ ハンドラ
...
// Kojika 20090529 Add End
	...
	// 項目が選択されていない場合，メッセージを表示
	if ( !bNew && iSelect == -1 ) {
		//MessageBox("Please Select User", "USER ACCOUNT LIST", MB_OK | MB_ICONSTOP);
		//MessageBox("ユーザを選択してください", "USER ACCOUNT LIST", MB_OK | MB_ICONSTOP);
