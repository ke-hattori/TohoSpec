// RecipeRecalibrationProgramView.cpp : インプリメンテーション ファイル
//
...
// =========================================================================
// CRecipeRecalibrationProgramView 診断
...
// =========================================================================
// CRecipeRecalibrationProgramView メッセージ ハンドラ
...
// Kojika 20090527 Change
		...
		//strcpy(m_RecalibProgInfo.hdr.szName, "タイトルなし");
...
// Kojika 20090527 Change
			...
			//MessageBox("第１基準値と最終基準値の間に入力されていないセルがあります.", m_strCaption, MB_OK | MB_ICONSTOP);
...
// Kojika 20090527 Change
			...
			//MessageBox("第一基準値が不正です", m_strCaption, MB_OK | MB_ICONSTOP);
...
// Kojika 20090527 Change End
		...
		if ( iRow != 1 ) {
/* modified 2015.12.06 hmenjo リカリブ逆相関対応 ---------- { ---------- */
//			//2009.09.01 bagus stress --{--
...
// Kojika 20090527 Change
					...
					//MessageBox("傾きが上昇方向になるように入力してください", m_strCaption, MB_OK | MB_ICONSTOP);
...
// Kojika 20090527 Change
				...
				//MessageBox("入力されていないセルがあります", m_strCaption, MB_OK | MB_ICONSTOP);
...
// Kojika 20090527 Change
			...
			//MessageBox("第１実測値と最終実測値の間に入力されていないセルがあります", m_strCaption, MB_OK | MB_ICONSTOP);
...
// Kojika 20090527 Change
			...
			//MessageBox("第一実測値が不正です", m_strCaption, MB_OK | MB_ICONSTOP);
...
/* modified 2015.12.06 hmenjo グラフバグ修正 ---------- { ---------- */
...
// Kojika 20090527 Change
	...
	//strcpy(tGraphConfig.UpperTitle,"リキャリブレーション グラフ");
...
// Kojika 20090527 Change
	...
	//strcpy(tGraphConfig.Y_AxisTitle,"実測値データ");
	//strcpy(tGraphConfig.X_AxisTitle,"基準値データ");
