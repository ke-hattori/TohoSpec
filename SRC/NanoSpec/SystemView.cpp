// SystemView.cpp : インプリメンテーション ファイル
//
...
// =========================================================================
//
IMPLEMENT_DYNCREATE(CSystemView, CNanoUI)

// =========================================================================
//
CSystemView::CSystemView()
	: CNanoUI(CSystemView::IDD)
{
...
// =========================================================================
//
BEGIN_MESSAGE_MAP(CSystemView, CNanoUI)
...
// =========================================================================
// CSystemView メッセージ ハンドラ

// =========================================================================
//
HBRUSH CSystemView::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// =========================================================================
//
void CSystemView::ControlColor(CDC* pDC, CBrush* pBrush, COLORREF Color)
{
	pBrush->DeleteObject();
