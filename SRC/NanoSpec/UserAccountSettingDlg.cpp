// UserAccountSettingDlg.cpp : �C���v�������e�[�V���� �t�@�C��
//
...
/////////////////////////////////////////////////////////////////////////////
// CUserAccountSettingDlg �_�C�A���O                                       //
//                                                                         //
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CUserAccountSettingDlg ���b�Z�[�W �n���h��
...
{
	//// Load Data /////
	ConfigFile_GetNanoSpecIni(m_AccessLevel, CONFIG_FILE_ACCESS_LEVEL); 	// �A�N�Z�X���x���͎Q�Ə��Ƃ��Ďg�p����i�X�V�Ȃ��j
...
BOOL CUserAccountSettingDlg::CheckData()
{
	...
	if ( strcmp(m_UserAccount.szName, "TOHO") == 0 ) {
		...
		//MessageBox("���̖��O�͓��͂ł��܂���. �Ⴄ���O����͂��Ă�������", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
	...
	if ( strlen(m_UserAccount.szName) == 0 ) {
		...
		//MessageBox("���[�U������͂��Ă�������", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
	...
	if ( strlen(m_UserAccount.szName) > USER_NAME_LEN ) {
		...
		// Kojika 20090529 Change
		//sprintf(szMsg, "%s%d%s%d%s", "���[�U���͔��p", USER_NAME_LEN, "����(�S�p", USER_NAME_LEN/2, "����)�ȓ��œ��͂��Ă�������");
	...
	if ( !CheckName(m_UserAccount.szName, USER_NAME_LEN) ) {
		...
		//MessageBox("���[�U���ɃX�y�[�X���Ǔ_���܂ނ��Ƃ͏o���܂���", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
	...
	if ( ((CComboBox*)GetDlgItem(IDC_ACCOUNT_LEVEL))->GetCurSel() == CB_ERR ) {
		...
		//MessageBox("�A�J�E���g���x����I�����Ă�������", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
	...
	if ( m_UserAccount.bEnablePassword ) {
		if ( strlen(m_UserAccount.szPassword) == 0 ) {
			...
			//MessageBox("�p�X���[�h����͂��Ă�������", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
	...
	if ( m_strConfirmPassword != m_UserAccount.szPassword ) {
		...
		//MessageBox("�p�X���[�h���Ⴂ�܂�", "USER ACCOUNT SETTING", MB_OK|MB_ICONSTOP);
