// RecipeMainListView.cpp : インプリメンテーション ファイル
//
...
/* added 2016.08.11 hmenjo 最大レシピ数制限 ---------- } ---------- */
	...
	while(bLoop){
		...
		if(RecipeFile_LoadRecipe(&MainRcpInfo, szName, RECIPE_FILE_MAIN_RECIPE)){
			// MeasurementProgramがLoadできないときはMeasItemは空白とする
