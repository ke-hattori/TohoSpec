// StressLineSectionSettingDlg.cpp : �C���v�������e�[�V���� �t�@�C��
//
...
//#define	DEFAULT_GRID_ROWS			30			// �O���b�h�̊�{�s��
#define	GRID_ROW_HEIGHT			18					// �O���b�h�̂P�s�̍���
//2009.09.24 bagus stress �C�� --}--
// 2009.09.17 bagus stress Grid�C�� --}--
...
/////////////////////////////////////////////////////////////////////////////
// CStressLineSectionSettingDlg �_�C�A���O
...
/////////////////////////////////////////////////////////////////////////////
// CStressLineSectionSettingDlg ���b�Z�[�W �n���h��
...
BOOL CStressLineSectionSettingDlg::OnInitDialog()
{
	...
	///// Stress Valid Range /////
//	m_strStressValidRange.Format("%f.3", (double)(m_StressConfig.lStressValidRange / MICROMETRE));			// �P�ʕϊ�(um->mm)
	m_strStressValidRange.Format("%d", m_StressConfig.lStressValidRange / MICROMETRE);						// �P�ʕϊ�(um->mm)

	///// Invalid Range /////
//	m_strInvalidRangeEdge.Format("%f.3", (double)m_StressConfig.lInvalidRangeEdge / MICROMETRE));			// �P�ʕϊ�(um->mm)
	m_strInvalidRangeEdge.Format("%d", m_StressConfig.lInvalidRangeEdge / MICROMETRE);					// �P�ʕϊ�(um->mm)

	///// Thick Measurement Point Offset /////
	m_strMeasPointOffsetX.Format("%ld", m_StressConfig.MeasOffset.lX / MICROMETRE);				// �P�ʕϊ�(um->mm)
	m_strMeasPointOffsetY.Format("%ld", m_StressConfig.MeasOffset.lY / MICROMETRE);				// �P�ʕϊ�(um->mm)
...
// 2009.09.17 bagus stress Grid�C�� --}--
	...
	for(i=0; i<static_cast<int>(m_StressConfig.dwLiftPinNumberOfLine); i++){
		...
		for (j=0; j<static_cast<int>(Rows); j++) {
			...
			Item.col = 1;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i].PinPos[j].lX / MICROMETRE));		// �P�ʕϊ�(um->mm)
			m_PinListGrid.SetItem(&Item);
// 2009.09.17 bagus stress Grid�C�� --{--
...
// 2009.09.17 bagus stress Grid�C�� --}--
			...
			Item.col = 2;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i].PinPos[j].lY / MICROMETRE));		// �P�ʕϊ�(um->mm)
			m_PinListGrid.SetItem(&Item);
// 2009.09.17 bagus stress Grid�C�� --{--
...
// 2009.09.17 bagus stress Grid�C�� --}--
	...
	for(i=FixRows; i<static_cast<int>(m_StressConfig.dwLiftPinNumberOfLine)+FixRows; i++){
		...
		for (j=row; j<row+Rows; j++) {
			...
			Item.col = 1;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i - FixRows].SectPos[j - row].lScanStartPosX / MICROMETRE));			// �P�ʕϊ�(um->mm)
			m_StressMeasurementLineSectionListGrid.SetItem(&Item);
			...
			Item.col = 2;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i - FixRows].SectPos[j - row].lScanEndPosX / MICROMETRE));			// �P�ʕϊ�(um->mm)
			m_StressMeasurementLineSectionListGrid.SetItem(&Item);
			...
			Item.col = 3;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i - FixRows].SectPos[j - row].lScanPosY / MICROMETRE));			// �P�ʕϊ�(um->mm)
			m_StressMeasurementLineSectionListGrid.SetItem(&Item);
		}
...
// 2009.09.11 bagus stress �C�� --}--
			Item.col = 1;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i].MeasPos[j].lX / MICROMETRE));		// �P�ʕϊ�(um->mm)
			m_NecessaryThicknessMeasurementListGrid.SetItem(&Item);
...
// 2009.09.11 bagus stress �C�� --}--
			Item.col = 2;
			Item.nFormat = dwTextStyle;
			Item.strText.Format("%.3f", (double)(m_StressConfig.Line[i].MeasPos[j].lY / MICROMETRE));		// �P�ʕϊ�(um->mm)
			m_NecessaryThicknessMeasurementListGrid.SetItem(&Item);
...
// 2009.09.04 bagus stress ���l�`�F�b�N�ǉ� --{--
	if (!CheckInvalidRangeEdgeData()) {
// 2009.09.09 bagus stress StringTable�g�p --{--
...
// 2009.09.04 bagus stress ���l�`�F�b�N�ǉ� --}--
	...
	m_StressConfig.lInvalidRangeEdge = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)
...
// 2009.09.04 bagus stress ���l�`�F�b�N�ǉ� --}--
	...
	m_StressConfig.MeasOffset.lX = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)
...
// 2009.09.08 bagus stress �`�F�b�N�����ǉ� --{--
	if(!CheckLineNum()) {
// 2009.09.09 bagus stress StringTable�g�p --{--
...
// 2009.09.11 bagus stress �`�F�b�N�ǉ� --{--
...
// 2009.09.15 bagus stress �C�� --{--
//		tmpPinX = strtod(Item.strText, NULL) * MICROMETRE;		// �P�ʕϊ�(um->mm)
...
// 2009.09.15 bagus stress �C�� --}--
		...
		m_PinListGrid.GetItem(&Item);
// 2009.09.15 bagus stress �C�� --{--
//		tmpPinY = strtod(Item.strText, NULL) * MICROMETRE;		// �P�ʕϊ�(um->mm)
		if (!CheckInputValueDouble(Item.strText, &tmpPin))
			return ( FALSE );
...
// 2009.10.19 K.Matsuo �L������͈͂̐ݒ�ɕύX -->
...
//			m_StressConfig.Line[i].SectPos[j].lScanEndPosX = PinXE - m_StressConfig.lStressValidRange;
			m_StressConfig.Line[i].SectPos[j].lScanStartPosX = ((PinXS + PinXE) / 1000 / 2 * 1000) - m_StressConfig.lStressValidRange;	// mm�����_�ȉ��́A�؂藎�Ƃ�
			m_StressConfig.Line[i].SectPos[j].lScanEndPosX = ((PinXS + PinXE) / 1000 / 2 * 1000) + m_StressConfig.lStressValidRange;		// mm�����_�ȉ��́A�؂藎�Ƃ�
// 2009.10.19 K.Matsuo �L������͈͂̐ݒ�ɕύX <--
...
{
	// TODO: ���̈ʒu�ɃR���g���[���ʒm�n���h���p�̃R�[�h��ǉ����Ă�������
// 2009.09.08 bagus stress LineNum�̃`�F�b�N --{--
#if 0
	CString	sNumOfLine;
	DWORD	NumOfLine;
...
#endif
// 2009.09.15 bagus stress �C�� --}--
	m_StressConfig.lStressValidRange = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)
...
// 2009.09.11 bagus stress ���_�ʒu�Ή� --{--
...
// 2009.09.17 bagus stress Grid�C�� --}--
	...
	// Range Pin
	GetDlgItemText(IDC_STRESS_VALID_RANGE, strBuffer);
	CheckStressConfig.lStressValidRange = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)

	// Range Edge
	GetDlgItemText(IDC_INVALID_RANGE_EDGE, strBuffer);
	CheckStressConfig.lInvalidRangeEdge = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)

	// Offset X
	GetDlgItemText(IDC_THICK_MEASUREMENT_POINT_OFFSET_X, strBuffer);
	CheckStressConfig.MeasOffset.lX = (long)(strtod(strBuffer.GetBuffer(0), NULL) * MICROMETRE);	// �P�ʕϊ�(mm->um)
...
//#else
	...
	for(i=0; i<static_cast<int>(CheckStressConfig.dwLiftPinNumberOfLine); i++){
		...
		for (j=0; j<static_cast<int>(Rows); j++) {
			...
			PinXS = strtod(Item.strText, NULL) * MICROMETRE;		// �P�ʕϊ�(um->mm)

			Item.mask = GVIF_TEXT;
			Item.row = i;
			Item.col = 2;
			m_StressMeasurementLineSectionListGrid.GetItem(&Item);
			PinXE = strtod(Item.strText, NULL) * MICROMETRE;		// �P�ʕϊ�(um->mm)

			Item.mask = GVIF_TEXT;
			Item.row = i;
			Item.col = 3;
			m_StressMeasurementLineSectionListGrid.GetItem(&Item);
			PinYS = strtod(Item.strText, NULL) * MICROMETRE;		// �P�ʕϊ�(um->mm)
...
#else
	// SET LINE/SECTION �����������_�Ō��܂�̂ŁA�ҏW�`�F�b�N�̓X���[
	for(i=0; i<STRESS_LINES_MAX; i++){
