// RecipeMeasurementSrThicknessProgramView.cpp : インプリメンテーション ファイル
//
...
// =========================================================================
// CRecipeMeasurementSrThicknessProgramView メッセージ ハンドラ
// =========================================================================
//
...
// 2013.11.11 Bagus Mod (TohoSpec対応) -->
...
// 2013.11.07 Bagus Add (TohoSpec対応) -->
	if(g_lModelType == MODEL_T3100){
		...
		if((m_ThickMeas.Ref.hdr.dLifeTime - (int)m_ThickMeas.Ref.hdr.dLifeTime) != 0) { //整数でない
