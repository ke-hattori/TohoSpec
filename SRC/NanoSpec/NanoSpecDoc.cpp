...
/* modified 2016.05.12 hmenjo 6500/TS3100 �� version ----------              */
	...
	sprintf_s(szBuff, sizeof(szBuff), "START Nanospec %s (%s %s)", l_szVersion, __DATE__, __TIME__);
/* modified 2016.05.12 hmenjo 6500/TS3100 �� version ---------- } ---------- */
...
/* modified 2016.05.12 hmenjo 6500/TS3100 �� version ----------              */
	...
	sprintf_s(szBuff, sizeof(szBuff), "END    Nanospec %s (%s %s)", l_szVersion, __DATE__, __TIME__);
/* modified 2016.05.12 hmenjo 6500/TS3100 �� version ---------- } ---------- */
// 2013.11.15 Bagus Add (TohoSpec�Ή�) -->
	if(g_lAppNameType != APP_NAME_NANO){
		CString strMsg;
