// UserSettingOperationCTASettingDlg.cpp : インプリメンテーション ファイル
//
...
CUserSettingOperationCTASettingDlg::CUserSettingOperationCTASettingDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CUserSettingOperationCTASettingDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CUserSettingOperationCTASettingDlg)
		// メモ - ClassWizard はこの位置にマッピング用のマクロを追加または削除します。
	//}}AFX_DATA_INIT
}


void CUserSettingOperationCTASettingDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CUserSettingOperationCTASettingDlg)
		// メモ - ClassWizard はこの位置にマッピング用のマクロを追加または削除します。
	//}}AFX_DATA_MAP
...
BEGIN_MESSAGE_MAP(CUserSettingOperationCTASettingDlg, CDialog)
	//{{AFX_MSG_MAP(CUserSettingOperationCTASettingDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CUserSettingOperationCTASettingDlg メッセージ ハンドラ
BOOL CUserSettingOperationCTASettingDlg::OnInitDialog()
{
...
// =========================================================================
//
void CUserSettingOperationCTASettingDlg::OnRecipeDefaultValueSettingButton()
{
	//Saiki 20090609 Add ----->
	...
	dlg.m_DefaultHeadType = HEAD_TYPE_CTA;
	ShowSettingDlg(&dlg);
}

// =========================================================================
//
BOOL CUserSettingOperationCTASettingDlg::ShowSettingDlg(CDialog* pDlg)
{
	//Saiki 20090528 Add ----->
...
HBRUSH CUserSettingOperationCTASettingDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CUserSettingOperationCTASettingDlg::OnTimer(UINT nIDEvent)
{
