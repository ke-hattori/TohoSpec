...
//Kojika 20090525 Change
	switch (nError) {
		case 0: 					  //str = "The operating system is out\nof memory or resources."; break;
			LoadStringML(IDS_OPERATING_SYSTEM_OUT , strBuffer, "The operating system is out\nof memory or resources.");
			str = strBuffer;
			break;
		case SE_ERR_PNF:			  //str = "The specified path was not found."; break;
			LoadStringML(IDS_SPECIFIED_PATH_NOT_FOUND , strBuffer, "The specified path was not found.");
			str = strBuffer;
			break;
		case SE_ERR_FNF:			  //str = "The specified file was not found."; break;
			LoadStringML(IDS_SPECIFIED_FILE_NOT_FOUND , strBuffer, "The specified file was not found.");
			str = strBuffer;
			break;
		case ERROR_BAD_FORMAT:		  //str = "The .EXE file is invalid\n(non-Win32 .EXE or error in .EXE image)."; break;
			LoadStringML(IDS_EXE_FILE_INVALID , strBuffer, "The .EXE file is invalid\n(non-Win32 .EXE or error in .EXE image).");
			str = strBuffer;
			break;
		case SE_ERR_ACCESSDENIED:	  //str = "The operating system denied\naccess to the specified file."; break;
			LoadStringML(IDS_OPERATING_SYSTEM_DENIED , strBuffer, "The operating system denied\naccess to the specified file.");
			str = strBuffer;
			break;
		case SE_ERR_ASSOCINCOMPLETE:  //str = "The filename association is\nincomplete or invalid."; break;
			LoadStringML(IDS_FILENAME_ASSOCIATION, strBuffer, "The filename association is\nincomplete or invalid.");
			str = strBuffer;
			break;
		case SE_ERR_DDEBUSY:		  //str = "The DDE transaction could not\nbe completed because other DDE transactions\nwere being processed."; break;
			LoadStringML(IDS_DDE_TRANSACTION_NOT_COMPLETE , strBuffer, "The DDE transaction could not\nbe completed because other DDE transactions\nwere being processed.");
			str = strBuffer;
			break;
		case SE_ERR_DDEFAIL:		  //str = "The DDE transaction failed."; break;
			LoadStringML(IDS_DDE_TRANSACTION_FAILED , strBuffer, "The DDE transaction failed.");
			str = strBuffer;
			break;
		case SE_ERR_DDETIMEOUT: 	  //str = "The DDE transaction could not\nbe completed because the request timed out."; break;
			LoadStringML(IDS_DDE_TRANSACTION_NOT_COMPLETE_TIMEOUT , strBuffer, "The DDE transaction could not\nbe completed because the request timed out.");
			str = strBuffer;
			break;
		case SE_ERR_DLLNOTFOUND:	  //str = "The specified dynamic-link library was not found."; break;
			LoadStringML(IDS_SPECIFIED_DLL_NOT_FOUND , strBuffer, "The specified dynamic-link library was not found.");
			str = strBuffer;
			break;
		case SE_ERR_NOASSOC:		  //str = "There is no application associated\nwith the given filename extension."; break;
			LoadStringML(IDS_NO_APPLICATION_ASSOCIATED , strBuffer, "There is no application associated\nwith the given filename extension.");
			str = strBuffer;
			break;
		case SE_ERR_OOM:			  //str = "There was not enough memory to complete the operation."; break;
 			LoadStringML(IDS_NOT_ENOUGH_MEMORY , strBuffer, "There was not enough memory to complete the operation.");
			str = strBuffer;
			break;
		case SE_ERR_SHARE:			  //str = "A sharing violation occurred. ";
			LoadStringML(IDS_SHARING_VIOLATION , strBuffer, "A sharing violation occurred. ");
			str = strBuffer;
		default:					  //str.Format(_T("Unknown Error (%d) occurred."), nError); break;
 			LoadStringML(IDS_UNKNOEWN_ERROR , strBuffer, "Unknown Error (%d) occurred.");
			str.Format(strBuffer, nError);
			break;
	}
	//str = "Unable to open hyperlink:\n\n" + str;
	LoadStringML(IDS_UNABLE_OPEN_HYPERLINK , strBuffer, "Unable to open hyperlink:\n\n");
	str = strBuffer + str;
