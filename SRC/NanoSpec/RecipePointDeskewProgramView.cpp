...
//	m_strCaption = "POINT DESKEW PROGRAM";
	...
	//m_strCaption = "�|�C���g �X���␳ �v���O����";
	//m_strCaption = "�|�C���g �f�X�L���[ �v���O����";
	//Saiki 20090410 Change <-----
	CString l_strBuffer;
...
// =========================================================================
// CRecipePointDeskewProgramView ���b�Z�[�W �n���h��
...
//		strcpy(m_PointDeskewProgInfo.hdr.szName, "�^�C�g���Ȃ�");
...
//		//Saiki 20090410 Change ----->
//		//MessageBox("�����X���␳���e�B�[�`���O���ĉ�����", m_strCaption, MB_OK | MB_ICONSTOP);
//		MessageBox("�I�[�g �f�X�L���[���e�B�[�`���O���ĉ�����", m_strCaption, MB_OK | MB_ICONSTOP);
//		//Saiki 20090410 Change <-----
