...
// 2013.11.12 Bagus Add (TohoSpec�Ή�) <--
		...
		m_MainMenuDataButton.SetShade(BUTTON_NORMAL_SHADEID, BUTTON_GRANULARITY, BUTTON_HIGHLIGHT, BUTTON_COLORING, BUTTON_RADIO_OFF_COLOR);	// ���I���J���[
// 2013.11.12 Bagus Add (TohoSpec�Ή�) -->
	}
// 2013.11.12 Bagus Add (TohoSpec�Ή�) <--

/* added 2014.11.21 hmenjo LOCAL ��\�� ---------- { ---------- */
	if (g_lModelType == MODEL_T3100) {
...
/* added 2014.11.21 hmenjo LOCAL ��\�� ---------- } ---------- */
	...
	m_MainMenuLogOnButton.SetShade(BUTTON_RADIO_SHADEID, BUTTON_GRANULARITY, BUTTON_HIGHLIGHT, BUTTON_COLORING, BUTTON_RADIO_OFF_COLOR);	// ���I���J���[
...
/////////////////////////////////////////////////////////////////////////////
// MEASUREMENT�ADATA�ARECIPE_SETTING�AALARM_HISTORY�̂����ꂩ�̃{�^���������̏���
...
/////////////////////////////////////////////////////////////////////////////
// UpdateButtonStatus �{�^���J���[��ύX���邽�߁A�{�^���X�e�[�^�X���擾����
...
// 2013.11.12 Bagus Add (TohoSpec�Ή�) <--
	...
	while ( pos != NULL ) {
		...
		if ( key == Select )
			button->SetShade(BUTTON_RADIO_SHADEID, BUTTON_GRANULARITY, BUTTON_HIGHLIGHT, BUTTON_COLORING, BUTTON_RADIO_ON_COLOR);	// �I���J���[
		else
			button->SetShade(BUTTON_RADIO_SHADEID, BUTTON_GRANULARITY, BUTTON_HIGHLIGHT, BUTTON_COLORING, BUTTON_RADIO_OFF_COLOR);	// ���I���J���[
	}
