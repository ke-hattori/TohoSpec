// PointSetupRectangleDlg.cpp : インプリメンテーション ファイル
//
...
CPointSetupRectangleDlg::CPointSetupRectangleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CPointSetupRectangleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPointSetupRectangleDlg)
	//}}AFX_DATA_INIT
}


void CPointSetupRectangleDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPointSetupRectangleDlg)
	//}}AFX_DATA_MAP

	DDX_Control(pDX, IDC_RECTANGLE_POINT_LIST_GRID, m_PointListGrid);
	DDX_Control(pDX, IDOK, m_OkButton);
	DDX_Control(pDX, IDCANCEL, m_CancelButton);
}


BEGIN_MESSAGE_MAP(CPointSetupRectangleDlg, CDialog)
	//{{AFX_MSG_MAP(CPointSetupRectangleDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

// =========================================================================
// CPointSetupRectangleDlg メッセージ ハンドラ
...
// =========================================================================
//
void CPointSetupRectangleDlg::GridDisp(CGridCtrl* pGrid, int row, int col, char* text, DWORD TextStyle)
{
	GV_ITEM Item;
	DWORD dwTextStyle;
...
// =========================================================================
//
void CPointSetupRectangleDlg::GridEditable(CGridCtrl* pGrid, BOOL Editable)
{
	pGrid->SetEditable(Editable);
	pGrid->EnableSelection(Editable);
	pGrid->SetTrackFocusCell(Editable);
	pGrid->SetFrameFocusCell(Editable);
...
// =========================================================================
//
BOOL CPointSetupRectangleDlg::PointListGrid_Init(CGridCtrl* pGrid)
{
	///// Grid Initialize /////
	GV_ITEM Item;
	int Cols = 3;
