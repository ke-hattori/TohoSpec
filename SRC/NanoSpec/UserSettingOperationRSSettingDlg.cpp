// UserSettingOperationRSSettingDlg.cpp : インプリメンテーション ファイル
//
...
CUserSettingOperationRSSettingDlg::CUserSettingOperationRSSettingDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CUserSettingOperationRSSettingDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CUserSettingOperationRSSettingDlg)
		// メモ - ClassWizard はこの位置にマッピング用のマクロを追加または削除します。
	//}}AFX_DATA_INIT
}


void CUserSettingOperationRSSettingDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CUserSettingOperationRSSettingDlg)
	//}}AFX_DATA_MAP
	DDX_Control(pDX, IDC_RECIPE_DEFAULT_VALUE_SETTING_BUTTON, m_RecipeDefaultValueSettingButton);
}


BEGIN_MESSAGE_MAP(CUserSettingOperationRSSettingDlg, CDialog)
	//{{AFX_MSG_MAP(CUserSettingOperationRSSettingDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CUserSettingOperationRSSettingDlg メッセージ ハンドラ
BOOL CUserSettingOperationRSSettingDlg::OnInitDialog()
{
...
// =========================================================================
//
void CUserSettingOperationRSSettingDlg::OnRecipeDefaultValueSettingButton()
{
	CMainFrame* pMainFrame = (CMainFrame *)AfxGetMainWnd();
	if ( !pMainFrame->MenuExit() )
		return;
	CSrRecipeDefaultValueSettingDlg dlg;
	dlg.m_DefaultHeadType = HEAD_TYPE_4PP;
	ShowSettingDlg(&dlg);
}

// =========================================================================
//
BOOL CUserSettingOperationRSSettingDlg::ShowSettingDlg(CDialog* pDlg)
{
...
HBRUSH CUserSettingOperationRSSettingDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CUserSettingOperationRSSettingDlg::OnTimer(UINT nIDEvent)
{
