...
//Saiki 20090530 Add <-----
	...
	case SITEPR_MODE:
		...
		sprintf_s(m_szTitle, _countof(m_szTitle), "%s", (LPCTSTR)strTitle);
		sprintf_s(m_szMessage, _countof(m_szMessage), "%s", (LPCTSTR)strMsg);
		sprintf_s(m_szGroup, _countof(m_szGroup), "%s", (LPCTSTR)strGrp);
		//Saiki 20090530 Change <-----
