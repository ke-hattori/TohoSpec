// PatRecDeskewDlg.cpp : �C���v�������e�[�V���� �t�@�C��
//
...
//Saiki 20090530 Add <-----
	...
	case SITEPR_MODE:
		...
		//sprintf(m_szTitle, "%s",	"�T�C�g�p�^�[���ݒ�");
		//sprintf(m_szMessage, "%s",	"�p�^�[�����͂��Ă�������");
		//sprintf(m_szGroup, "%s",	"�T�C�g�p�^�[��");
	...
	default:
		//Saiki 20090530 Change ----->
		//sprintf(m_szTitle, "%s",	"�f�X�L���[�ݒ�");
		//sprintf(m_szMessage, "%s",	"�p�^�[���}�[�N���͂��Ă�������");
		//sprintf(m_szGroup, "%s",	"�f�X�L���[");
...
//	SetMessage("Enclose the pattern mark");
	//Saiki 20090530 Change ----->
//	CreateDialogItem("BUTTON", "�ƍ�",			BS_PUSHBUTTON,	CRect(CPoint(499,487), CSize(94,24)),	IDC_DESKEW_VERIFY_BUTTON);
////	CreateDialogItem("BUTTON", "�f�X�L���[",	BS_GROUPBOX,	CRect(CPoint(295,362), CSize(320,155)), IDC_STATIC);
//	CreateDialogItem("BUTTON", m_szGroup,		BS_GROUPBOX,	CRect(CPoint(295,362), CSize(320,155)), IDC_STATIC);
//	CreateDialogItem("STATIC", "�\�[�X",		SS_CENTERIMAGE, CRect(CPoint(300,372), CSize(40,8)),	IDC_STATIC);
//	CreateDialogItem("STATIC", "�F���X�R�A",	SS_CENTERIMAGE, CRect(CPoint(499,467), CSize(40,12)),	IDC_STATIC);
//	CreateDialogItem("STATIC", "",				SS_SUNKEN,		CRect(CPoint(544,467), CSize(35,12)),	IDC_DESKEW_MATCH_SCORE);
//	CreateDialogItem("STATIC", "%", 			SS_CENTERIMAGE, CRect(CPoint(584,467), CSize(8,12)),	IDC_STATIC);
//	CreateDialogItem("STATIC", "",				SS_BLACKFRAME,	CRect(CPoint(300,382), CSize(110,130)), IDC_DESKEW_MODEL);
//	CreateDialogItem("STATIC", "�����Y",		SS_CENTERIMAGE, CRect(CPoint(499,450), CSize(40,12)),	IDC_STATIC);
//	CreateDialogItem("STATIC", "",				SS_SUNKEN,		CRect(CPoint(544,450), CSize(35,12)),	IDC_LENS);
