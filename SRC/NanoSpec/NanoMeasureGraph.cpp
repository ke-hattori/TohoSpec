...
//2009.09.03 bagus se �I�[�g�X�P�[�� --{--
	...
	if (m_bAutoScaleMode) {
		...
		//2010.01.19 bagus --{--
			...
			m_Config.Y_Step = static_cast<float>((m_dYMax -m_dYMin) / 10);
			if(m_Config.Y_Step > 10){
				//10�ȏ�ł��ꂠ��1�̈ʂ�؂�̂��������ɕύX����
				if(m_Config.Y_Step % 10 >= 5){
					m_Config.Y_Step = (m_Config.Y_Step + 5) - (m_Config.Y_Step % 10);
		...
		m_Config.Y_Max = static_cast<float>(m_dYMax);
		m_Config.Y_Origin = static_cast<float>(m_dYMin);
	}
//2009.09.03 bagus se �I�[�g�X�P�[�� --}--
...
//2009.09.03 bagus se �I�[�g�X�P�[�� --{--
	if (m_bAutoScaleMode) {
		m_Config.Y_Origin = static_cast<float>(dScaleYMin);
		m_Config.Y_Max = static_cast<float>(dScaleYMax);
		m_Config.Y_Step = static_cast<float>(dScaleYStep);
	}
//2009.09.03 bagus se �I�[�g�X�P�[�� --}--
}
