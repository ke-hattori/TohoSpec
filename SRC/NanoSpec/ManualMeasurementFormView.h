...
// ManualMeasurementFormView.h : �w�b�_�[ �t�@�C��
//
...
{
protected:
	CManualMeasurementFormView();			// ���I�����Ɏg�p�����v���e�N�g �R���X�g���N�^�B
...
//Saiki 20090924 Add <-----
	CAdditionalMeasurementDlg* m_pAddMeasDlgObj; //CAdditionalMeasurementDlg�̃I�u�W�F�N�g�̃|�C���^�i�[�p
...
/* deleted 2009.06.15 hmenjo ���[�U��`���b�Z�[�W�n���h�� IF �C�� ---------- { ---------- */
