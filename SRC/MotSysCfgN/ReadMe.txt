========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MotSysCfg
========================================================================


AppWizard が生成した MotSysCfg には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MotSysCfg を構成している各ファイルの概要説明が含まれています。
...
MotSysCfg.h
    ...
    みます） をインクルードし、また CMotSysCfgApp アプリケーションクラスを宣
    言します。

MotSysCfg.cpp
    このファイルは CMotSysCfgApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MotSysCfg.ico
    ...
    ルです。このアイコンはリソース ファイル MotSysCfg.rc によってインクルード
    されます。
...
MotSysCfgDlg.h, MotSysCfgDlg.cpp - ダイアログ
    これらのファイルは CMotSysCfgDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な MotSysCfg.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MotSysCfg.pch 
