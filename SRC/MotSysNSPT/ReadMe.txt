========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MotSys
========================================================================


AppWizard が生成した MotSys には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MotSys を構成している各ファイルの概要説明が含まれています。
...
MotSys.h
    ...
    みます） をインクルードし、また CMotSysApp アプリケーションクラスを宣
    言します。

MotSys.cpp
    このファイルは CMotSysApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MotSys.ico
    ...
    ルです。このアイコンはリソース ファイル MotSys.rc によってインクルード
    されます。
...
MotSysDlg.h, MotSysDlg.cpp - ダイアログ
    これらのファイルは CMotSysDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な MotSys.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MotSys.pch 
