...
#define I8255_DEVICE_TYPE 0x8001

// The IOCTL function codes from 0x800 to 0xFFF are for customer use.
// The IOCTL Device Type codes from 0x8000 to 0xFFFF are for customer use.

#define IO_READ_UCHAR \
    CTL_CODE( I8255_DEVICE_TYPE, 0x800, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IO_READ_USHORT \
    CTL_CODE( I8255_DEVICE_TYPE, 0x801, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IO_READ_ULONG \
    CTL_CODE( I8255_DEVICE_TYPE, 0x802, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IO_WRITE_UCHAR \
    CTL_CODE( I8255_DEVICE_TYPE, 0x810, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IO_WRITE_USHORT \
    CTL_CODE( I8255_DEVICE_TYPE, 0x811, METHOD_BUFFERED, FILE_ANY_ACCESS )
#define IO_WRITE_ULONG \
    CTL_CODE( I8255_DEVICE_TYPE, 0x812, METHOD_BUFFERED, FILE_ANY_ACCESS )
