...
namespace _DSHOWLIB_NAMESPACE
{
	...
	inline bool		IVCDSwitchProperty::getSwitch() const
	{
		VARIANT_BOOL rval;
	...
	inline bool		IVCDSwitchProperty2::hasDefault() const
	{
		VARIANT_BOOL def;
		return SUCCEEDED(get_Default( &def ));
	}
	inline bool		IVCDSwitchProperty2::getDefault() const
	{
		VARIANT_BOOL def;
