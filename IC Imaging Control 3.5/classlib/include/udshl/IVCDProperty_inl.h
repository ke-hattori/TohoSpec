...
{	
	...
	inline smart_com<IVCDPropertyInterface>	IVCDPropertyElements::findInterface( const wchar_t* pElementName, const GUID& itfTypeID ) const
	{
		if( pElementName == 0 )		return 0;
	...
	inline smart_com<IVCDPropertyInterface> IVCDPropertyElement::getInterface( const GUID& id ) const
	{
