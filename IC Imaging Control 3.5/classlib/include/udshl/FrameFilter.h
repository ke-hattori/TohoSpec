...
namespace _DSHOWLIB_NAMESPACE
{
	...
	*/
	...
	{
		eNO_ERROR = 0,
        eINVALID_PARAM_VALUE = 7, // tErrorEnum::eINVALID_PARAM_VALUE
        ePARAM_NOT_FOUND = 1001,
		eINCOMPATIBLE_PARAM_VALUE = 1002,
		eINVALID_FILTER_STATE = 1003,
	};
	...
	public:
		 ...
		 */
		tFilterError	setParameter( const std::wstring& name, const _variant_t& value )           { return setParameter_( name.c_str(), value ); }
		tFilterError	setParameter( const std::wstring& name, const std::wstring& value )         { return setParameter_( name.c_str(), value.c_str() ); }
		tFilterError	setParameter( const std::wstring& name, bool value )                        { return setParameter_( name.c_str(), _variant_t( value ) ); }
		tFilterError	setParameter( const std::wstring& name, long value )                        { return setParameter_( name.c_str(), _variant_t( value ) ); }
		tFilterError	setParameter( const std::wstring& name, float value )                       { return setParameter_( name.c_str(), _variant_t( value ) ); }
		tFilterError	setParameter( const std::wstring& name, int value )                         { return setParameter_( name.c_str(), _variant_t( long(value) ) ); }
		tFilterError	setParameter( const std::string& name, const _variant_t& value )            { return setParameter( astows( name ), value ); }
		tFilterError	setParameter( const std::string& name, const std::string& value )           { return setParameter( astows( name ), astows( value ) ); }
		tFilterError	setParameter( const std::string& name, bool value )                         { return setParameter( astows( name ), value ); }
		tFilterError	setParameter( const std::string& name, long value )                         { return setParameter( astows( name ), value ); }
		tFilterError	setParameter( const std::string& name, float value )                        { return setParameter( astows( name ), value ); }
		tFilterError	setParameter( const std::string& name, int value )                          { return setParameter( astows( name ), value ); }
		...
		tFilterError	getParameter( const std::wstring& name, bool& value )   { return getParameterT( name, value ); }
		tFilterError	getParameter( const std::string& name, bool& value )    { return getParameter( astows( name ), value ); }
        tFilterError	getParameter( const std::wstring& name, long& value )   { return getParameterT( name, value ); }
		tFilterError	getParameter( const std::string& name, long& value )    { return getParameter( astows( name ), value ); }
		tFilterError	getParameter( const std::wstring& name, int& value )    { return getParameterT( name, (long&)value ); }
		tFilterError	getParameter( const std::string& name, int& value )     { return getParameter( astows( name ), (long&)value ); }
		tFilterError	getParameter( const std::wstring& name, float& value )  { return getParameterT( name, value ); }
		tFilterError	getParameter( const std::string& name, float& value )   { return getParameter( astows( name ), value ); }
	...
	public:
		...
		virtual bool		callDialog( HWND hparent )			{ (void)hparent; return false; }
