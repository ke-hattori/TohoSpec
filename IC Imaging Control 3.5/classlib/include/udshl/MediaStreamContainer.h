...
namespace _DSHOWLIB_NAMESPACE
{
	...
	UDSHL_DEPRECATE_FUNCTION_T_("The OGM container was removed in 3.5")
	UDSHL_EXP_API_ extern const GUID MSC_OGMContainer;
	UDSHL_EXP_API_ extern const GUID MSC_MatroskaContainer;

    UDSHL_EXP_API_ extern const GUID MSC_MP4Container;
    UDSHL_EXP_API_ extern const GUID MSC_WMVContainer;
